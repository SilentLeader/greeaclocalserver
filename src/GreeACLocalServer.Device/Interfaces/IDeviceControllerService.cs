...
public interface IDeviceControllerService
{
    ...
    Task<DeviceFirmwareResult> GetDeviceFirmwareAsync(GetDeviceStatusRequest request, CancellationToken cancellationToken = default);
    Task<DeviceRuntimeStateResult> GetDeviceRuntimeStateAsync(GetDeviceStatusRequest request, CancellationToken cancellationToken = default);
